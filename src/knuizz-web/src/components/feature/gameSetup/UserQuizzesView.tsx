      ...
      >
        <Box p="3" style={{ height: 270 }}>
          ...
          {!isLoading && !quizzes?.length && (
            <Text color="gray">{t("userQuizzesView.emptyListMessage")}</Text>
          )}
                ...
                >
                  ...
                  >
                    <Text size="2" color="gray">
                      {t("userQuizzesView.byAuthor", {
                        authorName: quiz.authorName,
                      })}
                    </Text>
                    <Text size="2" color="gray">
                      {t("userQuizzesView.questionsCount", {
...
export default function UserQuizzesView({
  ...
  if (mode === "my") {
    return (
      <QuizList
        title={t("userQuizzesView.myQuizzesTitle")}
        quizzes={myQuizzes}
  ...
  if (mode === "search") {
    return (
      <Flex direction="column" gap="3">
        <TextField.Root
          placeholder={t("userQuizzesView.searchPlaceholder")}
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
        />
        <QuizList
          title={t("userQuizzesView.searchResultsTitle")}
