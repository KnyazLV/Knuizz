...
import { FloatingElementType } from '../../shared/types/FloatingElementType';
...
export default function FloatingElement({
    ...
    if (isQuestionMark) {
        return (
            <div style={style}>
                <Text as="div" style={{ fontSize: size, color: 'var(--slate-a5)' }}>?</Text>
            </div>
        );
    }
    ...
    return (
        <div style={iconStyle}>
            <img src={iconMap[type]} alt="floating icon" style={{ width: '100%', height: '100%' }} />
        </div>
    );
}
