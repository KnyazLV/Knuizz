    ...
    return (
        <>
            <Section className="relative min-h-[calc(100vh_-_65px)] flex flex-col items-center justify-center text-center px-2">
                ...
                <Text as="p" size="5" align="center" color="gray" mb="4" style={{ maxWidth: "600px" }}
                      className="animate__animated animate__fadeInUp animate__delay-1s">
                    Проверь свои знания в самых разных категориях — от науки до поп-культуры и
                    состязайся с другими знатоками за титул Князя знаний!
                </Text>
            ...
            <Section className="relative py-24 sm:py-32 bg-[var(--slate-2)]">
                ...
                <div className="inner-container relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    <Flex direction="column" gap="2">
                        <AnimatedWhenNotice>
                        <Flex direction="column" gap="2" className="animate__animated animate__slideInUp text-center">
                            <Badge color="purple" className="self-center">Pet-проект с открытым исходным кодом</Badge>
                            <Heading size="8" className="text-gradient">
                                О проекте Knuizz
                            </Heading>

                            <Text as="p" size="5" color="gray">
                                <Strong className="text-[var(--accent-11)]">Knuizz</Strong> — это платформа для викторин,
                                созданная в рамках демонстрации навыков full-stack разработки. Проект полностью открыт и продолжает развиваться.
                            </Text>
                            <Text as="p" size="5" color="gray">
                                Если вы встречаете баги, то смело сообщайте о них мне на почту: <a href="mailto:r.belovs@inbox.lv">r.belovs@inbox.lv</a> . Это ученический пет-проект,
                                поэтому я уверен, что в нём ещё множество ошибок.
                            </Text>
                            <Button variant="soft" size="3" asChild className="self-center">
                                <RadixLink href="https://github.com/KnyazLV/Knuizz" target="_blank">
                                    <GitHubLogoIcon />
                                    Исходный код
                                </RadixLink>
                            </Button>
                        ...
                        <Grid columns={{ initial: "1", sm: "2", lg: "3" }} gap="8" className="mt-16">
                            <AnimatedWhenNotice animationName="fadeInLeft">
                            <Box p="4">
                                <Flex p="4" direction="column" gap="2" className="items-center mb-6 animate__animated animate__fadeInLeft">
                                    <RocketIcon width="24" height="24" className="text-[var(--accent-11)]" />
                                    <Heading size="4" className="text-[var(--slate-12)]">
                                        Быстрые раунды
                                    </Heading>
                                </Flex>
                                <Text as="p" className="text-center" size="3" color="gray">
                                    Играйте в любое время и в любом месте. Один раунд викторины занимает всего несколько минут, идеально
                            ...
                            <AnimatedWhenNotice>
                            <Box p="4">
                                <Flex p="4" direction="column" gap="2" className="items-center mb-6">
                                    <CodeIcon width="24" height="24" className="text-[var(--accent-11)]" />
                                    <Heading size="4" className="text-[var(--slate-12)]">
                                        REST API
                                    </Heading>
                                </Flex>
                                <Text as="p" className="text-center" size="3" color="gray">
                                    Полнофункциональное API для разработчиков. Создавайте собственные клиенты, ботов или интегрируйте
                                    викторины в свои приложения.
                                </Text>
                            </Box>
                            </AnimatedWhenNotice>
                            ...
                            <Box p="4">
                                <Flex p="4" direction="column" gap="2" className="items-center mb-6">
                                    <BarChartIcon width="24" height="24" className="text-[var(--accent-11)]" />
                                    <Heading size="4" className="text-[var(--slate-12)]">
                                        Рейтинг и прогресс
                                    </Heading>
                                </Flex>
                                <Text as="p" className="text-center" size="3" color="gray">
                                    Отслеживайте свои достижения, соревнуйтесь с другими игроками и поднимайтесь в таблице лидеров.
                                </Text>
                            </Box>
                            </AnimatedWhenNotice>
                        </Grid>
