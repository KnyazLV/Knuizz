...
using Knuizz.Api.Application.DTOs.Seeding;
using Knuizz.Api.Domain.Entities;
using Microsoft.EntityFrameworkCore;

namespace Knuizz.Api.Infrastructure.Data.Seeding;
...
public class DataSeeder {
    ...
    private async Task SeedQuestionsFromCsvAsync(string filePath, string sourceName) {
        ...
        var config = new CsvConfiguration(CultureInfo.InvariantCulture) {
            ...
            ShouldSkipRecord = args => args.Row.Parser.Record == null || args.Row.Parser.Record.All(string.IsNullOrEmpty)
